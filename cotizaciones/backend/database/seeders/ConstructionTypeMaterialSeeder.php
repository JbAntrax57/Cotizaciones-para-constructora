    ...
    public function run()
    {
        $constructionTypeMaterials = [
            ...
            [
                ...
                'quantity_per_unit' => 0.386, // 1 saco por 70 ladrillos (27 ladrillos/m²)
                'unit_measure' => 'saco',
                'calculation_formula' => 'wall_area * 0.386',
                'is_required' => true,
                'sort_order' => 1,
            ...
            [
                ...
                'quantity_per_unit' => 27.0, // 27 ladrillos por m²
                'unit_measure' => 'pieza',
                'calculation_formula' => 'wall_area * 27',
                'is_required' => true,
                'sort_order' => 2,
